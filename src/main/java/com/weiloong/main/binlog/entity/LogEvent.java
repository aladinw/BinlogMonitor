...
import com.weiloong.main.binlog.mysql.MySqlEventTypeIdToString;
...
public class LogEvent implements Serializable {
    ...
    public LogEvent(final AbstractRowEvent re,String databaseName, String tableName){
        this.init(re);
    ...
    private void init(final BinlogEventV4 be){
        ...
        this.binlogName = header.toString();
